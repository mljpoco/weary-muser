...
export const articles = [
  {
    ...
    year: '2022',
    body:
      'It’s all rather silly, only I can’t quite explain why.<br><br>Something about sandcastles, and worrying you haven’t quite got it.<br><br>Where the light shows the way - go. To doubt it is like to lose faith in the ground below.<br><br>Right right right, it’s too obvious to say. “What is reality?” is less like a question, and more like a game.<br><br>Everything has two parts, the part you encounter depends entirely on the part you decide to play.<br><br>If you run away, you’re being chased.<br><br>If you relax, the world is at ease.<br><br>If you fear the unknown, the unknown becomes something to fear.<br><br>Too simple to make a lesson out of, and going crazy for the sake of driving the point is nothing more than a style of dance.<br><br>It could be a rock or an explosion - either way, it’s either a rock or an explosion.<br><br>The controls in this thing are maddeningly delicate.'
  },
  {
    id: 7,
    title: 'A Reflection on Anxiety',
    queryStr: '?aReflectionOnAnxiety',
    month: 'December',
    year: '2021',
    body:
      'I stare out of the window and procrastinate in defiance of my anxiety.<br><br>However, I perpetuate my anxiety in doing so.<br><br>"The more anxiety I can hold within myself without literally dying —the more mastery I have over it."<br><br>I am in an abusive relationship with my window.<br><br>I close the blinds, but it isn\'t really about the window, it\'s about me.<br><br>Maybe that\'s the problem.<br><br>I\'m so anxious about my anxiety, I forget that the longer I am idle, the more of a burden I am to myself and those around me.<br><br>"Do you really care if you\'re a burden to yourself and those around you? Does it really make any sense not to spend your days gazing anxiously out into nothingness, dimly hoping for something to come of it?" Something says.<br><br>I don\'t know how to respond, because I\'ve been listening to the voice for so long that I\'ve identified it as myself.<br><br>Checkmate again.<br><br>For some reason, this side of myself always wins — if it can be called that.<br><br>The side of me that writes this, that fights against it, seems to be AFK when it comes to reasoning emotionally.<br><br>It\'s infinitely more intelligent, but this is not a game it ever learned to play.<br><br>It was never masochistic enough to take it seriously.<br><br>Why in the world am I playing this game?<br><br><em>flips table and lives happily ever after</em>'
  },
  {
    id: 6,
    title: 'The Key Is Shaped Like It Isn\'t',
    queryStr: '?theKeyIsShapedLikeItIsnt',
    month: 'December',
    year: '2021',
    body:
      'The moment you comprehend, and it is fully evident in your experience the same way an apple is when you hold it before yourself, that it\'s all for nothing — that is the moment to press the gas.<br><br>When you see that really, REALLY, the edges of infinity\'s veil are not things out from which you could ever dream to have the capacity to pry yourself — sink your teeth into the bricks, laugh as your flesh and your limbs are ripped away, and sprint onward at and through that which you know to be fundamentally impenetrable the same way you would towards an old friend in an attempt to bestow the greatest hug that\'s ever been given.<br><br>That\'s when the gates can open.'
  },
  {
    id: 5,
    title: 'Disgust and Refinement',
    queryStr: '?disgustAndRefinement',
    month: 'December',
    year: '2021',
    body:
      'There is a disturbingly thin line between the disgusting and the refined — and a sort of countersteering action in place between the two which is mechanistically similar to the Christian model of repentance. Illustrated somewhat crudely: Those who consider themselves disgusting approach refinement, and those who consider themselves refined are disgusting. A kind of walking backwards in the attempt at becoming less disgusting or sinful, where at the moment when stepping back becomes a conscious action, the knees of the individual walking instantaneously invert like some sort of horrible fleshy moral compass protesting the traversal of an invisible equator.<br><br>The only way out of this bind is to become to yourself so slippery — so legitimately disgusting, that you effectively force the needle to the opposite side from the perspective of everyone around you. In other words, you have to abandon the pursuit of manifesting your personal concept of purity and every connotation associated with it whole-heartedly, and live as though the hour has struck where all the bets are off, without a care in the universe as to whether anyone’s opinion of your character or taste has any repercussions. A total and complete dive into whatever your genuine conception of depravity is, is the only thing that can save you once you gaze into the abyss that is this unintuitive dichotomy.<br><br>If somewhere in the process of your deliberate foray into darkness you lose the fiendish enthusiasm of one who’s spotted a shiny object in an empty home, you immediately become exactly as disgusting as you perceived the action to be. Have fun sorting that out. (No seriously, or you’ll mess it up.)'
  },
  {
    id: 4,
    title: 'The Why Phase',
